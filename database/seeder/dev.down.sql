...
BEGIN
    ...
    VALUES
        (u1, 'alice', 'alice@example.com', 'hashed1', 'user', TRUE, TRUE, 'basic'),
        (u2, 'bob', 'bob@example.com', 'hashed2', 'user', TRUE, FALSE, 'google'),
        (u3, 'carol', 'carol@example.com', 'hashed3', 'admin', TRUE, TRUE, 'basic'),
        (u4, 'dave', 'dave@example.com', 'hashed4', 'user', FALSE, TRUE, 'basic'),
        (u5, 'eve', 'eve@example.com', 'hashed5', 'user', TRUE, TRUE, 'google');
